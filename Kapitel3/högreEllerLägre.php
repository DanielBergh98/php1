<?php
    ...
    if(isset($_POST{"gissning"})) {
        $foregaendeTal=$_POST["foregandeTal"];
        $gissning=(int) $_POST["gissning"];
        $svar="Föregående tal var..." . $_POST["foregandeTal"];
    ...
    <body>
        ...
        <form method="POST">
            Jag tror nästa tal blir: <select name="gissning" size="1">
                ...
                <option value=-1>Samma</option>
                <option value=-1>Högre</option>
                </select>
            <br>
            <input type="submit" value="Skicka">
            <input type="hidden" name="foregandeTal" value="<?= $aktuelltTal; ?>">
